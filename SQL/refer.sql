...
('Матрос', 'after_1943', 18, 'Матрос'),
('Старший матрос', 'after_1943', 19, 'Старший матрос');
...
('Медаль Жукова', 'Награждаться военные и гражданские ветераны Красной Армии, Военно-Морского Флота, войск НКВД, партизаны и участники подполья за отвагу, стойкость и мужество, проявленные в боях с немецко-фашистскими захватчиками или против фашистской Германии. Японские милитаристы и в ознаменование 100-летия со дня рождения Георгия Жукова.', '09.05.1994', 'active');
